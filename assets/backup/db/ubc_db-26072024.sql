...
--
-- Host: localhost    Database: ubc_db
-- ------------------------------------------------------
...
INSERT INTO `doctrine_migration_versions` VALUES ('DoctrineMigrations\\Version20240726134549','2024-07-26 13:46:38',120);
...
CREATE TABLE `type_site` (
  ...
  `label_site` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
...
INSERT INTO `type_site` VALUES (1,'ravalement de facade',3),(2,'Devalement',NULL),(3,'Retoriquement',NULL);
...
INSERT INTO `yard` VALUES (2,'r\"rr',22222,'Estimate','Low','2024-07-25',NULL,1,NULL,'2024-10-24',1),(3,'Olivet',3000,'Estimate','Medium','2024-07-25',NULL,NULL,NULL,'2024-07-26',1),(4,'dddd',322,'Estimate','Low','2024-07-25',NULL,1,NULL,'2024-07-03',1),(5,'saint jean le blanc',4000,'Estimate','Medium','2024-07-26',NULL,1,NULL,'2024-07-28',1);
...
-- Dump completed on 2024-07-26 14:18:46
